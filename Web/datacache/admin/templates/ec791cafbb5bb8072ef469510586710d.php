		...
		<tr>
			...
			<td width="25%" id="infotype">
				...
				<table border="0" style="border-collapse:collapse" bordercolor="#FFFFFF">
					<tr>
						<td><a class="setedit" onclick="javascript:parent.onbotton('<?php echo $this->addslashes($this->_tpl_vars['array'][$list]['adtypename'],'hc') ?><?php echo $this->_tpl_vars['ST']['viewfield_botton'] ?>','index.php?archive=management&action=list&listfunction=advertlist&atid=<?php echo $this->_tpl_vars['array'][$list]['atid'] ?>&freshid='+Math.random()+'&iframename='+self.frameElement.getAttribute('name'),true,'typelist<?php echo $this->_tpl_vars['array'][$list]['atid'] ?>',self.frameElement.getAttribute('name'));" id="typelist<?php echo $this->_tpl_vars['array'][$list]['atid'] ?>" href="#body" title="<?php echo $this->_tpl_vars['ST']['viewfield_botton'] ?>" hidefocus="true"><?php echo $this->_tpl_vars['ST']['viewfield_botton'] ?></a></td>
