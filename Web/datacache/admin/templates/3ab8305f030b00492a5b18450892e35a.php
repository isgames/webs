	...
	<div id="head">
		...
		<div id="botton">
			<ul>
				...
				<?php } ?>
				<li id="bottonbg"><a class="tabclicklink" target="_blank" hidefocus="true" href="http://webscan.360.cn/index/checkwebsite/?url=<?php echo $this->_tpl_vars['softhttp'] ?>">360网站安全检测</a></li>
