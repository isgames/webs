...
<script type="text/javascript">
	...
	$().ready(function() {
		d1=new Date().getTime();esptabkey.showLoader();var w=$(window).width()-20;var h=$(window).height()-95;$('.divRight').css({width:w-175,height:h});$('#centerleft').css({height:h-10});$('#centerhidden').css({height:h});$('#srcolcontent').css({height:h-175});$('#modelleftcontent').css({height:h-45});$('#firefoxuser').html(($.browser.mozilla?'yes, your browser is Firefox':'oh, you are not using Firefox?'));$('#ieuser').html(($.browser.msie?'yes, your browser is Internet Explorer':'oh, you are not using Internet Explorer?'));		<?php echo $this->_tpl_vars['jsstr'] ?>
