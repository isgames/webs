			...
			<div class="maneditcontent">
				<table class="formtable">
					...
					<tr class="trstyle2">
						...
						<td width="85%" class="trtitle02">
							<input type="radio" value="1" name="istsn"<?php if($this->_tpl_vars['modelread']['istsn']==1){ ?> checked="checked"<?php } ?>/> <?php echo $this->_tpl_vars['ST']['open_botton_title'] ?>&nbsp;
							<input type="radio" value="0" name="istsn"<?php if($this->_tpl_vars['modelread']['istsn']==0){ ?> checked="checked"<?php } ?>/> <?php echo $this->_tpl_vars['ST']['close_botton_title'] ?>
					...
					<tr class="trstyle2">
						...
						<td width="85%" class="trtitle02">
							<input type="radio" value="1" name="isorder"<?php if($this->_tpl_vars['modelread']['isorder']==1){ ?> checked="checked"<?php } ?>/> <?php echo $this->_tpl_vars['ST']['open_botton_title'] ?>&nbsp;
							<input type="radio" value="0" name="isorder"<?php if($this->_tpl_vars['modelread']['isorder']==0){ ?> checked="checked"<?php } ?>/> <?php echo $this->_tpl_vars['ST']['close_botton_title'] ?>
